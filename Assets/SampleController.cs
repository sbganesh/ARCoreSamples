    ...
    protected override void OnEndManipulation(TapGesture gesture)
    {
            ...
            gesture.StartPosition.x, gesture.StartPosition.y, raycastFilter, out hit))
        {
            ...
            else
            {
                ...
                {
                    modelprefab = Instantiate(GameObjectVerticalPlanePrefab, hit.Pose.position, hit.Pose.rotation);
                ...
                {
                    modelprefab = Instantiate(GameObjectHorizontalUpwardPlanePrefab, hit.Pose.position, hit.Pose.rotation);
                    GenerateModels(modelprefab, hit);
